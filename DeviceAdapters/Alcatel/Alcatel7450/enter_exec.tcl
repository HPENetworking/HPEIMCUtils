...
while {$loop == "true"} {
	expect {
		...
		} -re $login_prompt|$username_prompt {
		...
		#Bitvise
		    ...
		    set ERROR_RESULT  true
			set ERROR_MESSAGE "Invalid username/password!"
			set loop false
		} -re "driver/access/invalid_user_pass" {
		    set ERROR_RESULT  true
			set ERROR_MESSAGE "driver/access/invalid_user_pass!"
			set loop false
		}
	}
}
